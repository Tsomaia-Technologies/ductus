---
name: task-status
description: Check the status of RFC 0001 implementation tasks. Use when the user asks about progress, what's done, or what's next.
---
...
- User asks "what's the status", "what's next", "which tasks are done"
- User wants to know which task to work on next
- User wants an overview of progress
