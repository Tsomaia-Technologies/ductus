...
| **`PersistenceProcessor`** | **Memory** | Long-term Memory | **Ledger.** Records durable "Facts" (Events) and State Snapshots. | *All Durable Events* | *None* |
...
* **Behavior:** Recorded in the **Hash-Chained Ledger**. Used for State Machine transitions.
