...
Ductus v2 is a complete foundational rewrite. It adopts **Event Sourcing**, a pure **Type Machine (XState)**, and a **Reactive Stream Processor (Multiplexer)** architecture. It introduces a rigorous Zero-Trust Orchestration pipeline, Proof-of-Work cryptographic event ledgers, and decoupled Agent topologies.
